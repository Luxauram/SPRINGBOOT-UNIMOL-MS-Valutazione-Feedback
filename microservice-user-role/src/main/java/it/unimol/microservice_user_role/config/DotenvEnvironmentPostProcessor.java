    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        for (String path : paths) {
            try {
                ...
                System.out.println("MS-USER: Tentativo caricamento da: " + path + " (assoluto: " + absolutePath + ")");

                File envFile = new File(dir, ".env");
                System.out.println("MS-USER: Cercando file: " + envFile.getAbsolutePath() + " - Esiste: " + envFile.exists());
        ...
        if (!envLoaded) {
            try {
                ...
                if (projectRoot != null) {
                    ...
                    System.out.println("MS-USER: Tentativo percorso progetto: " + envFile.getAbsolutePath() + " - Esiste: " + envFile.exists());
                    ...
                    if (envFile.exists() && envFile.canRead()) {
                        ...
                        if (dotenv != null && !dotenv.entries().isEmpty()) {
                            System.out.println("MS-USER: File .env caricato dalla root del progetto: " + projectRoot);
                            envLoaded = true;
                        }
                    }
                }
        ...
        if (envLoaded && dotenv != null) {
            ...
            System.out.println("MS-USER: File .env caricato con successo! Totale variabili: " + props.size());
        } else {
