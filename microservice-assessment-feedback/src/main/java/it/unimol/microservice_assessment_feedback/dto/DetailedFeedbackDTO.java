...
public class DetailedFeedbackDTO {
    ...
    @Schema(description = "La categoria del Feedback. Valori consentiti: CONTENT, PRESENTATION, CORRECTNESS, OTHER.",
            example = "POSITIVE",
    ...
    public DetailedFeedbackDTO(String id, String assessmentId, String feedbackText, FeedbackCategory category,
