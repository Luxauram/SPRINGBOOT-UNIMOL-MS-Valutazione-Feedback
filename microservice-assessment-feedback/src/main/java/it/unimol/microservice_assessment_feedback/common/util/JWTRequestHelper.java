...
public class JWTRequestHelper {
    ...
    public String getUsernameFromRequest(HttpServletRequest request) {
        ...
        if (username == null) {
            throw new IllegalStateException("Username non trovato nella request - verificare configurazione JWT interceptor");
        }
        return username;
    }
    ...
    public String getUserIdFromRequest(HttpServletRequest request) {
        ...
        if (userId == null) {
            throw new IllegalStateException("UserId non trovato nella request - verificare configurazione JWT interceptor");
        }
        return userId;
    }
    ...
    public String getUserRoleFromRequest(HttpServletRequest request) {
        ...
        if (userRole == null) {
            throw new IllegalStateException("UserRole non trovato nella request - verificare configurazione JWT interceptor");
        }
        return userRole;
    }

    /**
     * Estrae l'ID dello studente dalla richiesta HTTP.
     * Utilizza diversi metodi di fallback per recuperare l'informazione.
     *
    ...
    /**
     * Estrae l'ID del docente dalla richiesta HTTP.
     * Utilizza diversi metodi di fallback per recuperare l'informazione.
     *
     * @param request La richiesta HTTP contenente gli attributi o header JWT
