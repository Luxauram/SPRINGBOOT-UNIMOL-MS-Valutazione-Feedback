package it.unimol.microservice_assessment_feedback.service.events;
...
public class NotificationService {
    ...
    public void notifyTeacherOfSubmission(String teacherId, String assignmentId, String studentId) {
        String message = String.format(
                "[%s] NUOVA CONSEGNA - Docente: %s | Assignment: %s | Studente: %s | Azione richiesta: Valutazione",
    ...
    public void notifyTeacherOfExamCompletion(String teacherId, String examId, String studentId) {
        String message = String.format(
                "[%s] ESAME COMPLETATO - Docente: %s | Esame: %s | Studente: %s | Azione richiesta: Correzione",
    ...
    public void sendAssessmentReminder(String teacherId, String assignmentId) {
        String message = String.format(
                "[%s] PROMEMORIA - Docente: %s | Assignment: %s | Azione: Valutazione in sospeso da più di 48h",
    ...
    public void notifyStudentOfFeedback(String studentId, String assessmentId, String courseId) {
        String message = String.format(
                "[%s] NUOVO FEEDBACK - Studente: %s | Assessment: %s | Corso: %s | Visualizza il tuo feedback",
     ...
     */
    public void notifyStudentOfGrade(String studentId, String examId, String grade, Integer score, Integer maxScore) {
        String message = String.format(
     ...
     */
    public void notifyStudentOfSurvey(String studentId, String surveyId, String courseId, String surveyType) {
        String message = String.format(
                "[%s] NUOVO SURVEY - Studente: %s | Survey: %s | Corso: %s | Tipo: %s | Compila entro 7 giorni",
     ...
     */
    public void notifyStudentsOfAssignmentUpdate(String assignmentId, String courseId, String updateType, String title) {
        String message = String.format(
                "[%s] ASSIGNMENT MODIFICATO - Assignment: %s | Corso: %s | Titolo: %s | Modifica: %s | Controlla i dettagli aggiornati",
        ...
        switch (updateType) {
            case "DUE_DATE_CHANGED":
                logger.warn("SCADENZA MODIFICATA - Assignment: {} | Corso: {} | Notifica inviata agli studenti",
                        assignmentId, courseId);
                break;
            case "MAX_SCORE_CHANGED":
                logger.info("PUNTEGGIO MODIFICATO - Assignment: {} | Corso: {} | Notifica inviata agli studenti",
                        assignmentId, courseId);
                break;
            case "REQUIREMENTS_CHANGED":
                logger.warn("REQUISITI MODIFICATI - Assignment: {} | Corso: {} | Notifica inviata agli studenti",
                        assignmentId, courseId);
                break;
            default:
    ...
    public void notifyCourseDeletion(String courseId, String teacherId, String reason) {
        String message = String.format(
                "[%s] CORSO CANCELLATO - Corso: %s | Docente: %s | Motivo: %s | Tutti i dati sono stati archiviati",
    ...
    public void sendWelcomeNotification(String userId, String userType, String department) {
        String message = String.format(
                "[%s] BENVENUTO - Utente: %s | Tipo: %s | Dipartimento: %s | Accesso al sistema Assessment & Feedback attivato",
    ...
    public void activatePostExamSurvey(String studentId, String examId, String courseId) {
        String message = String.format(
                "[%s] SURVEY POST-ESAME - Studente: %s | Esame: %s | Corso: %s | La tua opinione è importante",
    ...
    public void scheduleFeedbackSurvey(String studentId, String examId, String courseId) {
        String message = String.format(
                "[%s] SURVEY FEEDBACK - Studente: %s | Esame: %s | Corso: %s | Programmato per invio automatico",
                getCurrentTimestamp(), studentId, examId, courseId
        );
